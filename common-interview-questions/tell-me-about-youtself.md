...
"I'm a backend engineer with 6 years of experience, currently working at Spordium — a sports tech platform — where I focus on backend services, infrastructure, and real-time systems."

---

**Part 2 — Core expertise**

"My primary stack is Python with FastAPI and Django, and on the data side I work with PostgreSQL, MongoDB, and Redis. For infrastructure I use AWS — EC2, RDS, CodeDeploy — and I manage CI/CD pipelines with Jenkins. For the last two years I've been exclusively focused on backend and infrastructure, so that's where my depth is. I'm responsible for APIs, real-time services, AI-powered services, and the deployment pipelines that hold everything together."
